...
const AddressForm = () => {
  ...
  return (
    ...
    >
      ...
      <FormField name="city" label="City" {...methods.register('city')} className="col-span-full" />
      <FormField name="zipcode" label="Post code" {...methods.register('zipcode')} />
      <FormField name="country" label="Country" {...methods.register('country')} />
